...
const SmartButtonCard = () => {
  ...
  return (
    <Card>
        ...
        <AnimatePresence mode="wait">
          {status === "idle" ? (
            ...
            >
              ...
              <button className="flex items-center justify-center gap-2 rounded-lg bg-black px-4 py-2 text-sm font-medium text-white hover:bg-neutral-800 dark:bg-white dark:text-black dark:hover:bg-neutral-200 transition-colors">
      ...
      <p className="absolute bottom-4 text-xs text-neutral-400 font-mono">
        INTERACTIVE
      </p>
    </Card>
  );
